...
import { registerAdminTemplateReviewRoutes } from './modules/templates/admin-template-review.routes';
import { registerTemplateReportRoutes } from './modules/templates/template-report.routes';
import { registerAdminTemplateReportRoutes } from './modules/templates/admin-template-report.routes';
import { registerAdminTemplateModerationRoutes } from './modules/templates/admin-template-moderation.routes';
import { registerTemplateAuthorRoutes } from './modules/templates/template-author.routes';
...
export function buildApp() {
  ...
  app.register(async (fastify) => {
    ...
    await registerAdminTemplateReviewRoutes(fastify);
    await registerTemplateReportRoutes(fastify);
    await registerAdminTemplateReportRoutes(fastify);
    await registerAdminTemplateModerationRoutes(fastify);
    await registerTemplateAuthorRoutes(fastify);
